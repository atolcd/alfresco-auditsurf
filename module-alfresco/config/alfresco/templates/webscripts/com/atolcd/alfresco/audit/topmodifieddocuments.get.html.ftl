...
<#if TopModifiedDocs?exists>
	<#if TopModifiedDocs?size !=0>
		<ul>
			<#-- Display : icon + filename + number of modification + fileinfo's icon -->
			<#list TopModifiedDocs?sort_by("value")?reverse as data>
				...
				<li>
					...
					(${data.value})<#-- number of modification -->
