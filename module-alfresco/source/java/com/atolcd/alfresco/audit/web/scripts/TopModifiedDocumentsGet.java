...
public class TopModifiedDocumentsGet extends DeclarativeWebScript implements InitializingBean {
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
		try {
			...
			List<Object[]> entries = auditQueriesService.topModif();
			...
			// Insert into the map
			model.put("TopModifiedDocs", topList.entrySet());

			return model;
		} catch (Exception e) {
			throw new WebScriptException("[TopModifiedDocumentsGet] Error in executeImpl function");
		}
	}
}