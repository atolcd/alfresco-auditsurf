...
public class WorkflowCreationsGet extends DeclarativeWebScript implements InitializingBean {
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
		try {
			...
			model.put("WorkflowCreations", auditQueriesService.countWorkflows(calendars, period).entrySet());
			return model;
		} catch (Exception e) {
			throw new WebScriptException("[WorkflowCreationsGet] Error in execute function");
		}
	}
}