...
public class UserConnectionsGet extends DeclarativeWebScript implements InitializingBean {
	...
	protected Map<String, Object> executeImpl(WebScriptRequest req, Status status, Cache cache) {
		try {
			...
			model.put("userConnections", auditQueriesService.countConnections(calendars, period).entrySet());

			return model;
		} catch (Exception e) {
			throw new WebScriptException("[UserConnectionsGet] Error in execute function " + e.getMessage() + " " + e.getLocalizedMessage());
		}
	}
}